...
sealed class EventHandlers : Global
{
	public static void SetupEvents()
	{
		...
		Output_text.TextChanged += Output_text.ScrollEndEvent;
		...
		Input_Type.MouseMove += (s, e) => Follow(s, e, "Select a type of download.");
		Input_Format.MouseMove += (s, e) => Follow(s, e, "Format?");
		Input_Link.MouseMove += (s, e) => Follow(s, e, "Link?");
		Input_Name.MouseMove += (s, e) => Follow(s, e, "Name?");
		Button_Format.MouseMove += (s, e) => Follow(s, e, "Fetch file formats");
		Button_Update.MouseMove += (s, e) => Follow(s, e, "Update");
		CloseButton.MouseMove += (s, e) => Follow(s, e, "Close");
		Minimize.MouseMove += (s, e) => Follow(s, e, "Minimize");
		Open_Folder.MouseMove += (s, e) => Follow(s, e, "Open downloaded files.");
		ComboBox_Label_Custom.MouseMove += (s, e) => Follow(s, e, "Customize settings before downloading.");
		ComboBox_Label_Video.MouseMove += (s, e) => Follow(s, e, "Download the Video format.");
		ComboBox_Label_Audio.MouseMove += (s, e) => Follow(s, e, "Download the Audio format.");
		ComboBox_Label_Convert.MouseMove += (s, e) => Follow(s, e, "Convert a file to another format type.");
		Output_text.MouseMove += (s, e) => Follow(s, e, "Console Output");
		Window_Hidden.MouseMove += (s, e) => Follow(s, e, "Like bruh what's this Ⓒ thing? Isn't just I made CLI have a GUI?");
		Button_Download.MouseMove += (s, e) =>
		{
			Follow(s, e, "Download");
